...
public class Weapon extends Stuff{
	...
	public String toString() {
		return "Weapon [effets=" + effets + ", conditions=" + conditions
				+ ", stats=" + stats + ", bonus=" + bonus + ", getEffets()="
				+ getEffets() + ", getConditions()=" + getConditions()
				+ ", getStats()=" + getStats() + ", getBonus()=" + getBonus()
				+ ", getDescription()=" + getDescription() + ", getType()="
				+ getType() + ", getLevel()=" + getLevel() + ", getName()="
				+ getName() + ", getPicture()=" + getPicture()
